...
public final class DefaultMoviesRepository: MoviesRepository {
    ...
    public func popular(page: Int) async throws -> (movies: [Movie], totalPages: Int) {
        try await apiClient.popular(page: page)
    }

    public func movieDetail(id: Int) async throws -> Movie {
        try await apiClient.movieDetail(id: id)
    }

    public func search(query: String, page: Int) async throws -> (movies: [Movie], totalPages: Int) {
        try await apiClient.search(query: query, page: page)
    }

    public func personDetail(id: Int) async throws -> Person {
